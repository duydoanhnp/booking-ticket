...
import style from '../assets/css/BaiTapDatVe.module.css'
import "../assets/css/BaiTapDatVe.css"
...
export default class BaiTapDatVe extends Component {
    ...
    renderHangGhe = () =>{
        return this.arrGhe.map((ghe,key) =>{
            return <div key={key}>
                <HangGhe hangGhe = {ghe} soHangGhe = {key}/>
            </div>
        })
    }
  render() {
    return (
      <div className={`${style['bg-game']} m-0 p-0`}>
        <div className={`${style['bg-game-color']} m-0 p-0`}>
            <div className="container-fluid">
                <div className="row">
                    <div className="col-8">
                        <h1 className="text-warning display-4  text-center">ĐẶT VÉ XEM PHIM TẠI CYBERLEARN.VN</h1>
                            <div className='mt-5 text-light text-center' style={{fontSize:'25px'}}>Màn hình</div>
                    ...
                    <div className="col-4">
                        <div style={{fontSize:"35px"}} className="text-center display4 text-light mt-2">DANH SÁCH GHẾ BẠN CHỌN</div>
                        <ThongTinDatGhe/>
                    </div>
                </div>
            </div>
